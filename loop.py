...
# to specify the increment value by adding a thrid parameter: "range(2, 30 , 3):"
...
# "else" will NOT be executed if the loop is stopped by a break statment.
# break the loop whe nx is 3, and see what happens with "else block
for x in range (6):
  if x == 3: break
    print(x)
else:
